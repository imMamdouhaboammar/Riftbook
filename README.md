...
- **Want practical tools?** Start with the curated [Tool Stack](./tools/README.md).
- **Need reusable prompting systems?** Browse our [Prompt Library](./prompts/README.md).
- **Looking for agent-ready behaviors?** Check out the custom [Skills](./skills/README.md).
- **Need to establish repeatable processes?** Implement our [Workflows](./workflows/README.md).
- **Want to learn the foundations?** Learn the theory with [Learning Paths](./learning/README.md).
- **Need setup instructions or best practices?** Read our [Guides](./guides/README.md).

---

## Browse by Category

Explore the complete index of curated resource directories:

| Category | What you'll find | Start here |
|---|---|---|
