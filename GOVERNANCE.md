...
This file points contributors and maintainers to the main rules that keep Riftbook practical and consistent.
...
| [CODE_OF_CONDUCT.md](./CODE_OF_CONDUCT.md) | Basic contribution behavior expectations |

## Operating rule

Riftbook should stay workflow-first.

Every new resource should help a builder do one of these better:
...
- Learn an important agentic concept
