...
| **React Doctor** | React Quality | Use Case Tool | Auditing AI-written React, state/effects issues, performance checks, accessibility, CI PR review | [![View Card](../assets/icons/open-card.svg)](./react-quality/react-doctor.md) |
| **Superpowers** | Agentic Coding | Standard | Structured AI coding workflows, TDD, planning, review | [![View Card](../assets/icons/open-card.svg)](./agentic-coding/superpowers.md) |
| **Cursor** | Coding | Standard | Codebase context-aware edits, inline edits, multi-file refactors | [![View Card](../assets/icons/open-card.svg)](./coding/cursor.md) |
| **Chrome DevTools MCP** | Coding | Standard | Browser testing, console log inspection, UI automation | [![View Card](../assets/icons/open-card.svg)](./coding/chrome-devtools-mcp.md) |
| **Coolors** | Design | Standard | Theme palette generation, color contrasting | [![View Card](../assets/icons/open-card.svg)](./design/coolors.md) |
| **UI UX Pro Max** | AI UI/UX Skill | Standard | Helping coding agents generate better UI direction and design systems | [![View Card](../assets/icons/open-card.svg)](../skills/ui-ux/ui-ux-pro-max.md) |
| **Markdownlint** | Writing | Standard | Markdown style checking, documentation formatting | [![View Card](../assets/icons/open-card.svg)](./writing/markdownlint.md) |
| **Perplexity AI** | Research | Standard | Conversational web queries, latest tech stack analysis | [![View Card](../assets/icons/open-card.svg)](./research/perplexity-ai.md) |
| **GitHub Actions** | Automation | Standard | Continuous integration, staging deployments, test execution | [![View Card](../assets/icons/open-card.svg)](./automation/github-actions.md) |
