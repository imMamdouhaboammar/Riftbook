...
**Welcome.** If you are new to working with AI coding agents, start here.

This path gives you the right foundation before you try anything else. It is not the fastest way to get to "hello world." It is the right way to get to shipping something that works.
...
*What you will learn:* What a lead agent is, how to choose one, when to switch.
...
*What you will learn:* What to put in `RULES.md`, why agents need explicit rules, and how to start with just five.
...
- Identify when your lead agent is losing context and know what to do about it
- Set up a default tool stack that gives you a consistent starting point
