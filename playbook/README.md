...
<p align="center">
  This is the playbook I wish I had when I started building with coding agents.<br/>
  Not a list of shiny tools. Not generic advice.<br/>
...
| Badge | Meaning |
|---|---|
| ![PRO TIP](./assets/badges/pro-tip.svg) | A small practical shortcut that pays off quickly |
| ![DON'T BREAK](./assets/badges/dont-break.svg) | Something builders often damage without noticing |
| ![BIG ISSUE](./assets/badges/big-issue.svg) | A serious pattern that can waste time or break trust |
| ![MY MISTAKE](./assets/badges/my-mistake.svg) | A real mistake from direct experience |
| ![STORY](./assets/badges/story.svg) | A real example or short account of something that happened |
| ![TRY IT](./assets/badges/try-it.svg) | A practical exercise to apply the lesson immediately |
| ![QUICK WIN](./assets/badges/quick-win.svg) | Something that gives you visible results fast |
| ![DEFAULT STACK](./assets/badges/default-stack.svg) | A recommended setup or configuration to use as a starting point |
| ![RED FLAG](./assets/badges/red-flag.svg) | A warning sign that something is wrong or about to go wrong |
| ![COPY THIS](./assets/badges/copy-this.svg) | A prompt, command, or snippet ready to use directly |
| ![AGENT MOVE](./assets/badges/agent-move.svg) | A smart way to use a coding agent inside a workflow |
| ![SHIP CHECK](./assets/badges/ship-check.svg) | A final check before moving on or shipping something |
| ![MENTAL MODEL](./assets/badges/mental-model.svg) | A framework or concept that changes how you think about something |
| ![DO THIS FIRST](./assets/badges/do-this-first.svg) | The first action to take in a given situation |
| ![WHEN TO SWITCH](./assets/badges/when-to-switch.svg) | Signals that it is time to change agents, tools, or approach |
